...
class TaskPlannerAgent(ChatAgent):
    ...
    def step(
        ...
        Args:
            ...
            assistant_role_name (str, optional): The name of the role played by
                the assistant. (default: :obj:`""`)
            user_role_name (str, optional): The name of the role played by the
                user. (default: :obj:`""`)
        ...
        if assistant_role_name and user_role_name:
            self.task_planner_prompt = TextPrompt(
                ...
                " The roles involved are {assistant_role} and {user_role}.")
